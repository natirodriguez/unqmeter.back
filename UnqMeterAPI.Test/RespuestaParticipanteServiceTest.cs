...
namespace UnqMeterAPI.Test
{
    ...
    public class RespuestaParticipanteServiceTest
    {
        ...
        {
            return _repositorySlydeMocker;
        }

        [Test]
        public void SlydeConYSinRespuesta_GetSlydesNoRespondidas_SlydesSinRespuestaSoloHabilitadas()
        {
            ...
            Assert.AreEqual(1, slydesSinRespuesta?.Count);
        ...
        private List<Slyde> GetSlydesPresentacion1()
        {
            ...
            slydes.Add(new Slyde() { Presentacion = presentacion, Id = 2, HabilitadoParaResponder= false });
            slydes.Add(new Slyde() { Presentacion = presentacion, Id = 3, HabilitadoParaResponder = true });
